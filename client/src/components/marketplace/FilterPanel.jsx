...
function FilterPanel({ filters, onChange, onReset }) {
  ...
  return (
    <aside className="ruk-filter-panel ruk-filter-panel-box p-3">
      <h2 className="h5 fw-bold mb-3">Filter kreator</h2>
      ...
      <Button className="w-100" onClick={onReset} variant="outline">
        Reset filter
      </Button>
    </aside>
  )
